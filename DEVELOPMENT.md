...
1. Upgrade the version field in `package.json`
2. Upgrade the CHANGELOG.md and potentially the README.md
2. Run `./release.sh`

### Publish a Pre-Release

1. Upgrade the version field in `package.json` to something like `0.2.0-dev5`
2. Do a workflow dispatch for the pre-release. The CI will see the unusual
   version number and try to create a pre-release.
...
## Publish a Release (old, before CI)
